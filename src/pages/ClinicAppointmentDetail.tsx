...
const ClinicAppointmentDetail = () => {
  ...
  const basePath = isReceptionistRoute ? "/receptionist" : "/clinic";
  ...
  const fetchICDCodes = async (cId: string) => {
    const { data } = await supabase
        ...
        <div className="space-y-2">
            ...
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link to={`${basePath}/appointments`}>Appointments</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
          ...
          {appointment.doctors && (
            <p className="text-sm text-muted-foreground">
              Doctor: {appointment.doctors.profiles?.full_name || "Unknown"} ({appointment.doctors.specialization})
            </p>
          )}
        </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                      ...
                      <div className="col-span-full">
                        ...
                        <div className="flex items-center gap-4 mt-2">
                          <Slider
                            ...
                            className="flex-1"
                          />
                          <span className="font-medium w-8 text-center">{formData.pain_scale || 0}</span>
                        </div>
                      </div>
                    )}
                  </div>
                ...
                {/* Payment Section */}
                <div>
                  <h4 className="font-medium mb-3 text-sm text-muted-foreground uppercase tracking-wide">Payment & Fees</h4>
                ...
                <div className="flex justify-end gap-2 pt-4 border-t">
                  <Button type="button" variant="outline" onClick={() => navigate(`${basePath}/appointments`)}>
                    Cancel
                  </Button>
                  <Button type="submit" disabled={saving}>
                    {saving ? "Saving..." : existingRecord ? "Update Visit" : "Save Visit"}
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <Link 
                      to={`${basePath}/patients/${appointment.patient_id}`}
                      className="font-medium hover:underline"
                    >
                      {appointment.patients.full_name}
                    </Link>
                    <p className="text-xs text-muted-foreground">
                      {appointment.patients.patient_id} • {calculateAge(appointment.patients.date_of_birth)} years • {appointment.patients.gender}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {appointment.patients.address && (
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <span>{appointment.patients.address}</span>
                    </div>
                  )}
                </div>
                ...
                {appointment.patients.allergies && (
                  <div className="p-2 bg-red-50 rounded text-sm">
                    ...
                    <p className="text-red-600">{appointment.patients.allergies}</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            {isGynecologist && (
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div>
                    <Label className="text-xs">Last Menstrual Period</Label>
                    <Popover open={pregnancyDatePopoverOpen} onOpenChange={setPregnancyDatePopoverOpen}>
                      <PopoverTrigger asChild>
                        <Button variant="outline" className="w-full justify-start text-left font-normal">
                          <CalendarIcon className="mr-2 h-4 w-4" />
                          {pregnancyStartDate ? format(pregnancyStartDate, "PPP") : "Select date"}
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          onSelect={(date) => {
                            ...
                            setPregnancyDatePopoverOpen(false);
                          }}
                          initialFocus
                        />
                      </PopoverContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-medium">Medical Records & Documents</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
...
export default ClinicAppointmentDetail;
