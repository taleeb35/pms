...
const CityHyderabad = () => {
  ...
  useSEO({
    ...
    jsonLd: {
      ...
      "name": "Zonoir EMR Software - Hyderabad",
      "description": "Complete EMR and clinic management software for doctors in Hyderabad, Sindh, Pakistan",
  ...
  const features = [
    {
      ...
      description: "Manage patient appointments efficiently for your Hyderabad clinic",
    },
    {
      icon: Users,
  ...
  const testimonials = [
    {
      name: "Dr. Irfan Ahmed Shaikh",
      clinic: "Hyderabad Medical Center",
      rating: 5,
      review: "Zonoir has completely transformed how we manage our clinic. The Sindhi language support is excellent.",
    },
    {
      name: "Dr. Saira Hussain",
      clinic: "Latifabad Healthcare Clinic",
      rating: 5,
      review: "Best EMR solution for Hyderabad doctors. Easy to use and great customer support.",
    },
    {
      name: "Dr. Aslam Memon",
      clinic: "City Care Hospital",
      rating: 5,
      review: "Highly recommend for all healthcare professionals in Sindh. Excellent features and reliability.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Serving 200+ Clinics in Hyderabad</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              EMR Software for Doctors in <span className="text-primary">Hyderabad</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Pakistan's #1 clinic management solution designed specifically for healthcare professionals in Hyderabad, Sindh. 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-muted-foreground">Hyderabad Clinics</div>
            </div>
            <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Complete Clinic Management for Hyderabad Doctors
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to run your clinic efficiently, designed with input from healthcare professionals across Hyderabad and Sindh.
            </p>
          </div>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Why Hyderabad Doctors Choose Zonoir
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Join hundreds of successful clinics across Hyderabad and Sindh who trust Zonoir for their practice management.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              What Hyderabad Doctors Say About Us
            </h2>
          </div>
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-6">
            Ready to Transform Your Hyderabad Clinic?
          </h2>
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join 200+ successful clinics in Hyderabad. Start your free trial today.
          </p>
          <Button
            size="lg"
            variant="secondary"
