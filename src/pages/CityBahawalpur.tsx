...
const CityBahawalpur = () => {
  ...
  useSEO({
    ...
    jsonLd: {
      ...
      "name": "Zonoir EMR Software - Bahawalpur",
      "description": "Complete EMR and clinic management software for doctors in Bahawalpur, South Punjab, Pakistan",
  ...
  const features = [
    {
      ...
      description: "Manage patient appointments efficiently for your Bahawalpur clinic",
    },
    {
      icon: Users,
  ...
  const testimonials = [
    {
      ...
      clinic: "Bahawalpur Medical Complex",
      rating: 5,
      review: "Zonoir has made our clinic operations so much smoother. Highly recommended for South Punjab doctors.",
    },
    {
      name: "Dr. Farah Naz",
      clinic: "Model Town Healthcare",
      rating: 5,
      review: "The best clinic management software we've used. Great support team and easy to learn.",
    },
    {
      name: "Dr. Shahid Hussain",
      clinic: "Victoria Hospital Clinic",
      rating: 5,
      review: "Excellent EMR solution for Bahawalpur clinics. Patient management has never been easier.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Serving 150+ Clinics in Bahawalpur</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              EMR Software for Doctors in <span className="text-primary">Bahawalpur</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Pakistan's #1 clinic management solution designed specifically for healthcare professionals in Bahawalpur. 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-muted-foreground">Bahawalpur Clinics</div>
            </div>
            <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Complete Clinic Management for Bahawalpur Doctors
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to run your clinic efficiently, designed with input from healthcare professionals across Bahawalpur and South Punjab.
            </p>
          </div>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Why Bahawalpur Doctors Choose Zonoir
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Join hundreds of successful clinics across Bahawalpur who trust Zonoir for their practice management.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              What Bahawalpur Doctors Say About Us
            </h2>
          </div>
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-6">
            Ready to Transform Your Bahawalpur Clinic?
          </h2>
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join 150+ successful clinics in Bahawalpur. Start your free trial today.
          </p>
          <Button
            size="lg"
            variant="secondary"
