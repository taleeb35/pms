...
const CityRawalpindi = () => {
  ...
  useSEO({
    ...
    jsonLd: {
      ...
      "name": "Zonoir EMR Software - Rawalpindi",
      "description": "Complete EMR and clinic management software for doctors in Rawalpindi, Pakistan",
  ...
  const features = [
    {
      ...
      description: "Manage patient appointments efficiently for your Rawalpindi clinic",
    },
    {
      icon: Users,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Serving 400+ Clinics in Rawalpindi</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              EMR Software for Doctors in <span className="text-primary">Rawalpindi</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Pakistan's #1 clinic management solution designed specifically for healthcare professionals in Rawalpindi. 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-muted-foreground">Rawalpindi Clinics</div>
            </div>
            <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Complete Clinic Management for Rawalpindi Doctors
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to run your clinic efficiently, designed with input from healthcare professionals across Rawalpindi.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join hundreds of successful clinics in Saddar, Satellite Town, Bahria Town, and across Rawalpindi who trust Zonoir for their practice management.
              </p>
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-6">
            Ready to Transform Your Rawalpindi Clinic?
          </h2>
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join 400+ successful clinics in Rawalpindi. Start your free trial today.
          </p>
          <Button
            size="lg"
            variant="secondary"
