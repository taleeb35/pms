...
const CitySialkot = () => {
  ...
  useSEO({
    title: "Best EMR Software for Doctors & Clinics in Sialkot | Zonoir",
    description:
    ...
    jsonLd: {
      ...
      name: "Zonoir - EMR Software for Sialkot",
      applicationCategory: "HealthApplication",
      operatingSystem: "Web",
      description:
        "Complete clinic management and EMR software for doctors and healthcare providers in Sialkot, Punjab.",
      offers: {
        "@type": "Offer",
        price: "0",
        priceCurrency: "PKR",
  ...
  const testimonials = [
    {
      ...
      clinic: "Sialkot Medical Complex",
      rating: 5,
      text: "Zonoir has revolutionized our clinic operations in Sialkot. The patient management and scheduling features are exactly what we needed for our busy practice.",
    },
    {
      name: "Dr. Sadia Iqbal",
      clinic: "City Care Hospital",
      rating: 5,
      text: "As one of the leading healthcare providers in Sialkot, we needed reliable software. Zonoir delivers exceptional performance and their support team is outstanding.",
    },
    {
      name: "Dr. Tariq Cheema",
      clinic: "Cheema Healthcare Clinic",
      rating: 5,
      text: "The financial tracking and reporting features have given us complete visibility into our clinic's performance. Highly recommend Zonoir to all Sialkot doctors.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="container mx-auto px-4 py-20 text-center relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto space-y-8 relative">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight animate-fade-in">
            ...
            <br />
            <span className="text-foreground">Doctors in Sialkot</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-fade-in">
            Join healthcare providers across Sialkot who trust Zonoir for complete clinic management.{" "}
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            { number: "40+", label: "Clinics in Sialkot", icon: Stethoscope },
            { number: "150+", label: "Doctors Using Zonoir", icon: UserPlus },
            { number: "8K+", label: "Patients Managed", icon: Users },
          ].map((stat, index) => (
            <div
              key={index}
        ...
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl font-extrabold mb-6">
            <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
              Features Loved by Sialkot Doctors
            </span>
          </h2>
          <p className="text-muted-foreground text-xl max-w-3xl mx-auto">
            Everything you need to run a modern healthcare practice in Sialkot
          </p>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-12 text-center max-w-4xl mx-auto shadow-2xl">
          <h2 className="text-4xl font-extrabold text-white mb-6">
            Ready to Transform Your Sialkot Clinic?
          </h2>
          <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">
            Join the growing network of healthcare providers in Sialkot using Zonoir for better patient care.
          </p>
          <Button
            onClick={() => navigate("/login")}
            size="lg"
