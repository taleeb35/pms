          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join hundreds of successful clinics in D Ground, Peoples Colony, Madina Town, and across Faisalabad who trust Zonoir for their practice management.
              </p>
