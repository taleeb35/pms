...
const CityLahore = () => {
  ...
  return (
    <>
      <Helmet>
        <title>EMR Software for Doctors in Lahore | Clinic Management Software Lahore</title>
        <meta
          name="description"
          content="Best EMR software for doctors in Lahore. Complete clinic management solution with patient records, appointment scheduling, billing & prescriptions. Trusted by 500+ Lahore clinics."
        />
        <meta
          name="keywords"
          content="EMR software Lahore, clinic management software Lahore, doctor software Lahore, patient management Lahore, clinic software Gulberg, hospital software Lahore, medical billing software Lahore, prescription software Lahore, OPD management Lahore, healthcare software Lahore, electronic medical records Lahore, doctor appointment system Lahore, clinic ERP Lahore"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://zonoir.com/emr-software-lahore" />
        
        {/* Open Graph */}
        <meta property="og:title" content="EMR Software for Doctors in Lahore | Clinic Management Software" />
        <meta property="og:description" content="Best EMR software for doctors in Lahore. Complete clinic management solution trusted by 500+ Lahore clinics." />
        <meta property="og:url" content="https://zonoir.com/emr-software-lahore" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Join hundreds of successful clinics in Gulberg, Model Town, DHA, Johar Town, and across Lahore who trust Zonoir for their practice management.
                </p>
