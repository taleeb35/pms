...
const CityQuetta = () => {
  ...
  useSEO({
    title: "Best EMR Software for Doctors & Clinics in Quetta | Zonoir",
    description:
    ...
    jsonLd: {
      ...
      name: "Zonoir - EMR Software for Quetta",
      applicationCategory: "HealthApplication",
      operatingSystem: "Web",
      description:
        "Complete clinic management and EMR software for doctors and healthcare providers in Quetta, Balochistan.",
      offers: {
        "@type": "Offer",
        price: "0",
        priceCurrency: "PKR",
  ...
  const testimonials = [
    {
      name: "Dr. Abdul Rauf Khan",
      clinic: "Balochistan Medical Center",
      rating: 5,
      text: "Zonoir has transformed how we manage our clinic in Quetta. The software is intuitive and has significantly improved our patient care and record-keeping.",
    },
    {
      name: "Dr. Samina Durrani",
      clinic: "City Healthcare Clinic",
      rating: 5,
      text: "As a healthcare provider in Quetta, finding reliable software was challenging. Zonoir exceeded our expectations with its comprehensive features and excellent support.",
    },
    {
      name: "Dr. Nawaz Mengal",
      clinic: "Quetta Family Practice",
      rating: 5,
      text: "The finance tracking and patient management features have made our operations much more efficient. Highly recommend Zonoir for clinics in Balochistan.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            { number: "50+", label: "Clinics in Quetta", icon: Stethoscope },
            { number: "200+", label: "Doctors Using Zonoir", icon: UserPlus },
            { number: "10K+", label: "Patients Managed", icon: Users },
          ].map((stat, index) => (
            <div
              key={index}
        ...
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl font-extrabold mb-6">
            <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
              Features Loved by Quetta Doctors
            </span>
          </h2>
          <p className="text-muted-foreground text-xl max-w-3xl mx-auto">
            Everything you need to run a modern healthcare practice in Quetta
          </p>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-12 text-center max-w-4xl mx-auto shadow-2xl">
          <h2 className="text-4xl font-extrabold text-white mb-6">
            Ready to Transform Your Quetta Clinic?
          </h2>
          <p className="text-white/90 text-xl mb-8 max-w-2xl mx-auto">
            Join the growing network of healthcare providers in Quetta using Zonoir for better patient care.
          </p>
          <Button
            onClick={() => navigate("/login")}
            size="lg"
