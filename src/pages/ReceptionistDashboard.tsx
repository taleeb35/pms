        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-gradient-to-br from-info/20 to-info/5 flex items-center justify-center shadow-sm shrink-0">
              <img src={clinicLogo} alt="Zonoir" className="h-7 w-7 sm:h-9 sm:w-9 object-contain" />
            </div>
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground truncate">{clinicInfo?.clinic_name}</p>
            </div>
          </div>
          <div className="text-left sm:text-right bg-card/50 backdrop-blur-sm rounded-lg px-3 py-2 border border-border/40 self-start sm:self-auto">
            ...
            <p className="text-base sm:text-lg font-bold text-info">{stats.todayAppointments} <span className="text-xs font-normal text-muted-foreground">appts today</span></p>
          </div>
        </div>
      </div>
