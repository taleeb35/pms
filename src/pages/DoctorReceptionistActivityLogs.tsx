...
const DoctorReceptionistActivityLogs = () => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const userIds = [user.id, receptionist.doctor_id];
    ...
    <section className="space-y-6">
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Track all actions for your doctor</p>
        </div>
...
export default DoctorReceptionistActivityLogs;
