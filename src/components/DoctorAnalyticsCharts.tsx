...
const DoctorAnalyticsCharts = () => {
  ...
  }, [activeChart, datePeriod, customStartDate, customEndDate]);
  ...
  const fetchData = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from("patients")
        .select("id, gender, date_of_birth, city, created_at")
  ...
  const fetchRevenueData = async () => {
    try {
      ...
      const baseDate = datePeriod === "custom" && customStartDate ? customStartDate : new Date();
